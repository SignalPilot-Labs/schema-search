...
from schema_search.constants import DB_NAME_DEFAULT, STRATEGY_BM25, STRATEGY_HYBRID, STRATEGY_SEMANTIC
...
class SchemaSearch:
    def __init__(
        ...
        db_name = engine.url.database or DB_NAME_DEFAULT
    ...
    def search(
        ...
        if resolved_type in [STRATEGY_SEMANTIC, STRATEGY_HYBRID]:
            self._ensure_embeddings_loaded()

        if resolved_type in [STRATEGY_BM25, STRATEGY_HYBRID]:
